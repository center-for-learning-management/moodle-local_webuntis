...
$string['admin:curldebugging'] = 'Enable CURL-Debugging';
$string['admin:curldebugging:description'] = 'If enabled this will show detailed debugging information for each CURL request that is sent by PHP. Attention, this will show technical information including sensitive data and must be used carefully!';
...
$string['exception:invalid_field'] = 'Invalid field name!';
...
$string['exception:tenant_id_already_in_use'] = 'tenant_id already in use!';
...
$string['tenantcreate:failure'] = 'The creation of the tenant {$a->school} ({$a->tenant_id}) failed.';
$string['tenantcreate:success'] = 'Successfully created the tenant {$a->school} ({$a->tenant_id}).';
