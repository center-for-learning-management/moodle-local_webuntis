...
$string['admin:curldebugging'] = 'Aktiviere CURL-Debugging';
$string['admin:curldebugging:description'] = 'Diese Option aktiviert detaillierte debugging-Informationen über jeden CURL-Request, der zu WebUntis geschickt wird. Achtung, dies führt zu technischen Ausgaben, die sensible Informationen beinhalten können und sollte vorsichtig eingesetzt werden!';
...
$string['exception:access_token_expired'] = 'Der Zugangstoken ist abgelaufen. Bitte nochmal versuchen!';
...
$string['exception:invalid_field'] = 'Ungültiger Feldname!';
$string['exception:no_accesstoken_retrieved'] = 'Der Zugangstoken konnte nicht abgerufen werden: {$a}';
$string['exception:permission_denied'] = 'Zugriff nicht erlaubt!';
$string['exception:tenant_id_already_in_use'] = 'tenant_id wird bereits verwendet!';
...
$string['tenantcreate:failure'] = 'Die Erstellung des Tenants {$a->school} ({$a->tenant_id}) ist fehlgeschlagen.';
$string['tenantcreate:success'] = 'Tenant {$a->school} ({$a->tenant_id}) erfolgreich erstellt.';
