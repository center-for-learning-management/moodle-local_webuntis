...
class JWT
{
    ...
    * @throws UnexpectedValueException    Provided JWT was invalid because the signature verification failed
    ...
    * @throws UnexpectedValueException             Provided JWT has since expired, as defined by the 'exp' claim
    *
    * @uses jsonDecode
